<div>
  ...
  @partial link("YouTube Channel", "https://www.youtube.com/@JetzigWebFramework")
  ...
  <ul class="list-disc text-gray-500 ms-4 space-y-4">
    ...
    @partial link("MIT License", "https://github.com/jetzig-framework/jetzig/blob/main/LICENSE")
    ...
    @partial link("Zig Software Foundation", "https://ziglang.org/zsf/")
    ...
    @partial link("build system", "https://ziglang.org/learn/build-system/")
  ...
  <ul class="list-disc text-gray-500 ms-6 leading-8">
    <li>
      @partial link(title: "Zap", href: "https://github.com/zigzap/zap")
      : <i>blazingly fast backends in zig</i></li>
    <li>
      @partial link(title: "http.zig", href: "https://github.com/karlseguin/http.zig")
      : <i>An HTTP/1.1 server for Zig.</i></li>
    <li>
      @partial link(title: "tokamak", href: "https://github.com/cztomsik/tokamak")
      : <i>Server-side framework for Zig</i></li>
    <li>
      @partial link(title: "zig-router", href: "https://github.com/Cloudef/zig-router")
      : <i>Straightforward HTTP-like request routing.</i></li>
    <li>
      @partial link("zig-webui", "https://github.com/webui-dev/zig-webui/")
      : <i>Allows you to use any web browser as a GUI, with your preferred language in the backend and HTML5 in the frontend.</i></li>
    <li>
      @partial link(title: "ZTS", href: "https://github.com/zigster64/zts")
