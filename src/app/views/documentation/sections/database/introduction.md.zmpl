...
Currently only _PostgreSQL_ support is provided, but more adapters are planned to be released soon (including _SQLite_).

The _PostgreSQL_ adapter is built on top of [Karl Seguin](https://www.openmymind.net/)'s [pg.zig](https://github.com/karlseguin/pg.zig).
