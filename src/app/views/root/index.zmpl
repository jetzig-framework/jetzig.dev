...
<div class="grid grid-cols-1 sm:grid-cols-[10rem_auto] gap-8 mt-8 text-gray-500">
  ...
  <div>
    <p>Simple, file-based routing to {^link(title: "RESTful", href: "https://en.wikipedia.org/wiki/REST")} <i>Zig</i> function declarations.</p>
  </div>

  <h4 class="flex-initial text-xl font-bold text-[{:jetzig_orange}]"><i class="fa-solid fa-code fa-fw me-2"></i> HTML</h4>
  <div>
    <p>Templating with {^link(title: "Zmpl", href: "https://github.com/jetzig-framework/zmpl")}: <b>layouts</b>, <b>partials</b>, and build-time <b>static content rendering</b>.</p>
  </div>
  ...
  <div>
    <p>Hook into and manipulate requests/responses with a custom middleware chain. Built-in middleware for {^link(title: "htmx", href: "https://htmx.org/")}.</p>
  </div>

  <h4 class="flex-initial text-xl font-bold text-[{:jetzig_orange}]"><i class="fa-solid fa-heart fa-fw me-2"></i> Community</h4>
  <div>
    <p>Join us on {^link(title: "Discord", href: "https://discord.gg/eufqssz7X6")} &ndash; we're friendly and active.</p>
  </div>
  ...
  <div>
    <p>Free, open source, and always will be. <i>Jetzig</i> is {^link(title: "MIT", href: "https://en.wikipedia.org/wiki/MIT_License")} licensed.</p>
  </div>
</div>
